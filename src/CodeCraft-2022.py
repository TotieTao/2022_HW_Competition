...
def main():
    Demand = get_data("./CodeCraft-2022/src/demand.csv")
    Qos = get_data("./CodeCraft-2022/src/qos.csv")
    Site_bandwidth = get_data("./CodeCraft-2022/src/site_bandwidth.csv")

    os.makedirs("./CodeCraft-2022/output")
    data = open("./CodeCraft-2022/output/solution.txt", 'w', encoding="utf-8")

    config = configparser.ConfigParser()
    config.read("./CodeCraft-2022/src/config.ini")
